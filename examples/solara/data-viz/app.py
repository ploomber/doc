...
Inspired by: [Understanding GPT tokenizers by Simon Willison](https://simonwillison.net/2023/Jun/8/gpt-tokenizers/) & [GPT-4 Tokenizer](https://solara.dev/examples/ai/tokenizer)
